...
@QuarkusTest
@TestProfile(CaseCustomTlsRegistryTest.TestConf.class)
class CaseCustomTlsRegistryTest {

    @RestClient
    private MyClient myClient;

    @Test
    @DisplayName("when using the a tls registry loading the JVM cacerts ")
    void restClientUsingCacertsLoadedViaTlsRegistry() {
